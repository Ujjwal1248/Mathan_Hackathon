...
const mockTeamMembers: TeamMember[] = [
  { id: '1', name: 'Dr. Vivek Sharma', role: 'Medical Lead', status: 'available', location: 'Chennai' },
  { id: '2', name: 'Dhanraj Singh', role: 'Rescue Specialist', status: 'deployed', location: 'Kerala' },
  { id: '3', name: 'Shivansh Singh', role: 'Emergency Coordinator', status: 'available', location: 'Mumbai' },
  { id: '4', name: 'Ujjwal Agrawal', role: 'Logistics Manager', status: 'training', location: 'Delhi' }
];
